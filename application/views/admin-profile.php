...
<head>
	...
	<title>User Profile - Naqilcom</title>
			...
			<div class="row">
              ...
              <div class="row">
                      ...
                      <div class="panel-body">
						...
						<label class="col-lg-1 control-label" for="userimage">Image</label>
                      ...
                      <div class="form-group">
                        ...
                        <div id="inputUserName" class="col-lg-11">
                          <input type="text"  placeholder="Enter name" name="name" id="name" class="form-control" value="<?php echo $data['name'];?>">
                        </div>
                      </div>
					  <div class="form-group">
					  <label class="col-lg-1 control-label" for="name">User Name</label>
					  <div id="inputUserName" class="col-lg-11">
					  <input type="text"  placeholder="Enter userName" name="userName" id="userName" class="form-control" value="<?php echo $data['username']; ?>">
					  </div>
					  </div>
                      <div class="form-group">
                        <label class="col-lg-1 control-label" for="emailaddress">Email</label>
                        <div id="inputEmailAddress" class="col-lg-11">
                          <input type="text"  placeholder="Enter email address" name="emailaddress" id="emailaddress" class="form-control" value="<?php echo $data['email'] ?>">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="col-lg-1 control-label" for="contactnumber">Contact No</label>
                        <div id="inputContactNo" class="col-lg-11">
                          <input type="text"  placeholder="Enter contact number" name="contactnumber" id="contactnumber" class="form-control" value="<?php echo $data['mobile']; ?>" >
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-lg-1 control-label" for="userroll">Role</label>
