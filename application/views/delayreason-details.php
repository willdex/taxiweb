...
<head>
    ...
    <title>Edit Reason - NaqilCom</title>
                            ...
                            <div class="col-lg-12">
                                <div id="content-header" class="clearfix">
                                    ...
                                    <div class="pull-right">
                                        <ol class="breadcrumb">
                                            <li><a href="#">Home</a></li>
                                            <li class="active"><span>Edit Delay Reason</span></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="main-box clearfix">
                                    ...
                                    <?php
                                    $id=$_GET['id'];
                                    $query = $this->db->query("SELECT * FROM `delay_reasons` WHERE reason_id=$id");
                                    $row = $query->row('delay_reasons');
...
//												$query = $this->db->query("update time_detail set WHERE tid=$tid");
                                        ...
                                        if($this->db->update('delay_reasons', $data))
                                        {
                                            redirect(base_url().'admin/manage_delay_reasons');
                                        }
                                    }
                                    ?>
                                    <div class="main-box-body clearfix">
                                        <form  enctype="multipart/form-data" method="post" class="form-horizontal" id="formAddUser" name="add_user" role="form">
                                            <div class="form-group">
                                                <label class="col-lg-1 control-label" for="starttime">Reason Title</label>
                                                <div id="inputStartTime" class="col-lg-11">
                                                    <input type="text"  onkeydown="errorValidUser();" placeholder="Enter title" name="reason_title" id="reason_title" class="form-control" value="<?php echo $row-> reason_title;?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-1 control-label" for="endtime">Reason Text</label>
                                                <div id="inputEndTime" class="col-lg-11">
                                                    <textarea placeholder="Enter reason" name="reason_text" id="reason_text" class="form-control"><?php echo $row->reason_text; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
