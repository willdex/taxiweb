...
<head>
	...
	<title>Manage User - 24/7 Taxi</title>
								...
								<div class="main-box clearfix">
									<div class="panel">
										<div class="panel-body">
											<h2 class="pull-left">Manage User</h2>
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		...
		var dataTable = $('#example').DataTable( {
			...
			"ajax":{
				url : '<?php echo base_url(); ?>admin/get_user_data', // json datasource
	...
	function delete_user(){
		if( $('.deleteRow:checked').length > 0 ){  // at-least one checkbox checked
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>admin/delete_user_data",
	...
	function delete_single_user_action()
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>admin/delete_single_user_data",
			data: {data_id: single_id},
			success: function (result) {
				var oTable1 = $('#example').DataTable();
				oTable1.ajax.reload(null, false);
