...
<head>
	...
	<title>Manage Driver - 24/7 Taxi</title>
								...
								<div class="main-box clearfix">
									<div class="panel">
										<div class="panel-body">
											<h2 class="pull-left">Manage Driver</h2>
											<div class="filter-block pull-right">
												...
												<a class="btn btn-primary pull-right" href="javascript:void(0)" onclick="window.location.href='add_driver'">
...
<script type="text/javascript" language="javascript" >
	...
	$(document).ready(function() {
		...
		var dataTable = $('#example').DataTable( {
			...
			"ajax":{
				url : '<?php echo base_url(); ?>admin/get_driver_data', // json datasource
