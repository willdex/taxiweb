$(function($) {
	...
	if($("#config-fixed-header").is(':checked')){	//fixed header coding
	...
	if($("#config-fixed-footer").is(':checked')){	//fixed footer coding
	...
	if($("#config-fixed-sidebar").is(':checked')){	//fixed sidebar coding
