...
<head>
	...
	<title>Manage Day Time - 24/7 Taxi</title>
			...
			<div class="row">
							...
							<div class="row">
								<div class="col-lg-12">
									<div id="content-header" class="clearfix">
										<div class="pull-left">
											<h1>Manage Day Time</h1>
										</div>
                    <div class="pull-right">
                    	<ol class="breadcrumb">
												<li><a href="#">Home</a></li>
												<li class="active"><span>Manage Day Time</span></li>
											</ol>
                    </div>
									</div>
								</div>
              ...
              <div class="row">
                      ...
                      <div class="panel-body">
                        	<h2 class="pull-left">Manage Day Time</h2>
												...
												<table id="example" class="table table-hover table-bordered user-list">
													<thead>
														<tr>
															...
															<th><a href="javascript:void(0);">Start Time</a></th>
															<th><a href="javascript:void(0);">End Time</a></th>
	...
	<script type="text/javascript" language="javascript" >
		$(document).ready(function() {
			var dataTable = $('#example').DataTable( {
				...
				"ajax":{
					url : '<?php echo base_url(); ?>admin/get_time_type_data', // json datasource
