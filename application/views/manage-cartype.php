...
<head>
	...
	<title>Manage Car Type - 24/7 Taxi</title>
						...
						<div class="row">
							<div class="col-lg-12">
								<div id="content-header" class="clearfix">
									<div class="pull-left">
										<h1>Manage Car Type</h1>
									</div>
									<div class="pull-right">
										<ol class="breadcrumb">
											<li><a href="#">Home</a></li>
											<li class="active"><span>Manage Car Type</span></li>
										</ol>
									</div>
								</div>
							</div>
								...
								<div class="main-box clearfix">
									<div class="panel">
										<div class="panel-body">
											<h2 class="pull-left">Manage Car Type</h2>
											<div class="filter-block pull-right">
												...
												<a class="btn btn-primary pull-right" href="javascript:void(0)" onclick="window.location.href='add_car'">
													<i class="fa fa-plus-circle fa-lg"></i> Add Car Type
												</a>
												<span>&nbsp;</span>
										...
										<div class="table-responsive">
											<table id="example" class="table table-hover table-bordered user-list">
												...
												<tr>
													...
													<th><a href="javascript:void(0);">CAR ICON</a></th>
													<th><a href="javascript:void(0);">CAR TYPE</a></th>
													<th><a href="javascript:void(0);">CAR RATE</a></th>
													<th><a href="javascript:void(0);">LOADING CAPACITY</a></th>
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#example').DataTable( {
			...
			"ajax":{
				url : '<?php echo base_url(); ?>admin/get_car_data', // json datasource
	...
	function delete_user(){
		if( $('.deleteRow:checked').length > 0 ){  // at-least one checkbox checked
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>admin/delete_car_data",
	...
	function delete_single_user_action()
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>admin/delete_single_car_data",
